...
function App() {
  ...
  function removeAppointment(id) {
    const removeSelectedAppointment = appointments.filter(
    ...
    <div className="paper">
      <header>
        ...
        <Switch>
          ...
          <Route path="*">
            <h1>
              Uh oh! Looks like you're not in class and don't have a hall pass.
              Make an appointment with one of our tutors to get back on track!{" "}
            </h1>
          </Route>
        </Switch>
      </header>
